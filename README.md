...
- SRC_DIR = location of the AMQ 7 installer "amq-broker-7.1.0-bin.zip"
- SHARED_FILESYSTEM = location of the shared file system used for master and slave. The characters must be escaped.
- MASTER_IP= IP of the host where the master AMQ instance is deployed
- MASTER_PORT= port of the master AMQ instance
- SLAVE_PORT= port of the slave AMQ instance
- SLAVE_IP= IP of the host where the slave AMQ instance is installed
